...
### 1. [The Formatic Mark](../_ref/form_/formatic_mark.md)
...
### [Python Implementation](../_ref/form_/formatic_mark.py)
...
2. [The Formatic Mark](../_ref/form_/formatic_mark.md)
3. [Necessity Proof](necessity_proof.md)
4. [Python Implementation](../_ref/form_/formatic_mark.py)
...
|---------|-----------|----------|--------|----------|
| Local container | `()` | Object | `case` | [formatic_mark.md](../_ref/form_/formatic_mark.md) |
...
|--------|----------------|------------------|----------|
| Formatics | `([()]) ` | `(())` | [formatic_mark.md](../_ref/form_/formatic_mark.md) |
